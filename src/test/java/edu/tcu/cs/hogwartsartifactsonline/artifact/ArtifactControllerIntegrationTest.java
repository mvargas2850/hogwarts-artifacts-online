...
@DisplayName("Integration tests for Artifact API endpoints") //optional
@Tag("integration")
...
class ArtifactControllerIntegrationTest {
    ...
    @BeforeEach //will get called before each test case gets executed
...
//                "Basic " + Base64Utils.encodeToString("john:123456".getBytes())));
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        this.mockMvc.perform(get(this.baseUrl + "/artifacts").accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
                .andExpect(jsonPath("$.message").value("Find All Success"))
                .andExpect(jsonPath("$.data.content", Matchers.hasSize(7))); //not that you have added an artifact, there should be 7
    }
